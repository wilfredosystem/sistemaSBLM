...
@Repository(value = "arrendamientoDAO")
public class ArrendamientoDAO implements IArrendamientoDAO, Serializable {
	...
	public List<Seguimientoflujo> obtenerSeguimientoFlujodeDocumentoAtendido(
		...
		List<List> list = null;
		if(mesSeleccionado==0){
			list = session.createQuery("select new List(F.idflujodocumento,D.fechaderivaciondgai,D.titulo,D.nombreremitente,D.asunto,D.descripcion,U.idusuario,D.iddocumento,F.estadosupervisor,F.fecharecepcion,S.idusuarioremitente,S.idsegflujodocumento,U.idusuario,S.respuesta,S.fechaaprobacionrechazo) from Seguimientoflujo S inner join S.flujodocumento F   inner join S.usuario U inner join F.documento D where U.idusuario='"+FuncionesHelper.getUsuario().toString()+"' and S.estado!='NINGUNO' and S.idperfilusuario='"+129+"' order by S.fechaaprobacionrechazo desc ").list();
			
		}else {
			list = session.createQuery("select new List(F.idflujodocumento,D.fechaderivaciondgai,D.titulo,D.nombreremitente,D.asunto,D.descripcion,U.idusuario,D.iddocumento,F.estadosupervisor,F.fecharecepcion,S.idusuarioremitente,S.idsegflujodocumento,U.idusuario,S.respuesta,S.fechaaprobacionrechazo) from Seguimientoflujo S inner join S.flujodocumento F   inner join S.usuario U inner join F.documento D where U.idusuario='"+FuncionesHelper.getUsuario().toString()+"' and S.estado!='NINGUNO' and month(S.fechaaprobacionrechazo)='"+mesSeleccionado+"' and S.idperfilusuario='"+129+"' order by S.fechaaprobacionrechazo desc ").list();
		}
...
public  void settingLog(int idestadoauditoria, int ideventoauditoria, int idusuariodestino, String mensajePersonalizado){
	...
	public int obtenerNumeroDerivadosMes(int mesActualcapturado) {
		Long count = (Long) sessionFactory.openSession() 
				.createQuery("select COUNT(IDSEGFLUJODOCUMENTO) from Seguimientoflujo  S   inner join S.usuario U where U.idusuario='"+FuncionesHelper.getUsuario().toString()+"' and S.estado='atendido' and month(S.fechaaprobacionrechazo)='"+mesActualcapturado+"' and S.idperfilusuario='"+129+"' ").uniqueResult();
	...
	public int obtenerNumeroDocumentosMes(String respuesta) {
		Long count = (Long) sessionFactory.openSession()
				.createQuery("select COUNT(IDSEGFLUJODOCUMENTO) from Seguimientoflujo S  inner join S.usuario U  where  U.idusuario='"+FuncionesHelper.getUsuario().toString()+"' and S.estado='atendido' and S.respuesta ='"+respuesta+"' and S.idperfilusuario='"+129+"'").uniqueResult();
				return count.intValue();
	}
	...
	public int obtenerNumeroDerivados() {
		Long count = (Long) sessionFactory.openSession() 
				.createQuery("select COUNT(IDSEGFLUJODOCUMENTO) from Seguimientoflujo S  inner join S.usuario U  where  U.idusuario='"+FuncionesHelper.getUsuario().toString()+"' and S.estado='atendido' and S.idperfilusuario='"+129+"' ").uniqueResult();
				return count.intValue();
	}
	...
	public int obtenerNumeroPendientesMes(int mesActualcapturado) {
		Long count = (Long) sessionFactory.openSession()
				.createQuery("select COUNT(IDSEGFLUJODOCUMENTO) from Seguimientoflujo S  inner join S.usuario U  where  U.idusuario='"+FuncionesHelper.getUsuario().toString()+"' and S.estado='atendido' and month(S.fecharecepcion)='"+mesActualcapturado+"' and S.idperfilusuario='"+129+"' ").uniqueResult();
				return count.intValue();
	}
	...
	public int obtenerNumeroPendientes() {
		Long count = (Long) sessionFactory.openSession()
				.createQuery("select COUNT(IDSEGFLUJODOCUMENTO) from Seguimientoflujo S  inner join S.usuario U  where  U.idusuario='"+FuncionesHelper.getUsuario().toString()+"' and S.estado='NINGUNO'  and S.idperfilusuario='"+129+"'").uniqueResult();
				return count.intValue();
	}
	...
	public int obtenerNumeroDocumentosMes(String respuesta, int mesActualcapturado) {
		Long count = (Long) sessionFactory.openSession()
		.createQuery("select COUNT(IDSEGFLUJODOCUMENTO) from Seguimientoflujo S  inner join S.usuario U  where  U.idusuario='"+FuncionesHelper.getUsuario().toString()+"' and S.estado='derivado' and S.respuesta ='"+respuesta+"' and month(S.fechaaprobacionrechazo)='"+mesActualcapturado+"' and S.idperfilusuario='"+129+"'").uniqueResult();
		return count.intValue();
	}
	...
	public Boolean estaDocumentoFinalizado(int idsegflujodocumento) {
		Long count = (Long) sessionFactory.openSession()
				.createQuery("select count(*) from Seguimientoflujo S  where S.idsegflujodocumento='"+idsegflujodocumento+"' and S.respuesta='en proceso' and S.idperfilusuario='"+129+"'").uniqueResult();
		if(count.intValue()==0){
			return true;
		}else{
			return false;
