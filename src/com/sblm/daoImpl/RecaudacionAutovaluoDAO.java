...
@Repository(value = "recaudacionAutovaluoDAO")
public class RecaudacionAutovaluoDAO implements IRecaudacionAutovaluoDAO, Serializable {
...
public  void settingLog(int idestadoauditoria, int ideventoauditoria, int idusuariodestino, String mensajePersonalizado){
	...
	public int obtenerNumeroDerivadosMes(int mesActualcapturado) {
		Long count = (Long) sessionFactory.openSession() 
				.createQuery("select COUNT(IDSEGFLUJODOCUMENTO) from Seguimientoflujo  S   inner join S.usuario U where U.idusuario='"+FuncionesHelper.getUsuario().toString()+"' and S.estado='atendido' and month(S.fechaaprobacionrechazo)='"+mesActualcapturado+"' and S.idperfilusuario='"+123+"' ").uniqueResult();
	...
	public int obtenerNumeroDocumentosMes(String respuesta) {
		Long count = (Long) sessionFactory.openSession()
				.createQuery("select COUNT(IDSEGFLUJODOCUMENTO) from Seguimientoflujo S  inner join S.usuario U  where  U.idusuario='"+FuncionesHelper.getUsuario().toString()+"' and S.estado='atendido' and S.respuesta ='"+respuesta+"' and S.idperfilusuario='"+123+"'").uniqueResult();
				return count.intValue();
	}
	...
	public int obtenerNumeroDerivados() {
		Long count = (Long) sessionFactory.openSession() 
				.createQuery("select COUNT(IDSEGFLUJODOCUMENTO) from Seguimientoflujo S  inner join S.usuario U  where  U.idusuario='"+FuncionesHelper.getUsuario().toString()+"' and S.estado='atendido' and S.idperfilusuario='"+123+"'  ").uniqueResult();
				return count.intValue();
	}
	...
	public int obtenerNumeroPendientesMes(int mesActualcapturado) {
		Long count = (Long) sessionFactory.openSession()
				.createQuery("select COUNT(IDSEGFLUJODOCUMENTO) from Seguimientoflujo S  inner join S.usuario U  where  U.idusuario='"+FuncionesHelper.getUsuario().toString()+"' and S.estado='atendido' and month(S.fecharecepcion)='"+mesActualcapturado+"' and S.idperfilusuario='"+123+"' ").uniqueResult();
				return count.intValue();
	}
	...
	public int obtenerNumeroPendientes() {
		Long count = (Long) sessionFactory.openSession()
				.createQuery("select COUNT(IDSEGFLUJODOCUMENTO) from Seguimientoflujo S  inner join S.usuario U  where  U.idusuario='"+FuncionesHelper.getUsuario().toString()+"' and S.estado='NINGUNO' and S.idperfilusuario='"+123+"' ").uniqueResult();
				return count.intValue();
	}
	...
	public int obtenerNumeroDocumentosMes(String respuesta, int mesActualcapturado) {
		Long count = (Long) sessionFactory.openSession()
		.createQuery("select COUNT(IDSEGFLUJODOCUMENTO) from Seguimientoflujo S  inner join S.usuario U  where  U.idusuario='"+FuncionesHelper.getUsuario().toString()+"' and S.estado='derivado' and S.respuesta ='"+respuesta+"' and month(S.fechaaprobacionrechazo)='"+mesActualcapturado+"' and S.idperfilusuario='"+123+"'").uniqueResult();
		return count.intValue();
	}
	...
	public Boolean estaDocumentoFinalizado(int idsegflujodocumento) {
		Long count = (Long) sessionFactory.openSession()
				.createQuery("select count(*) from Seguimientoflujo S  where S.idsegflujodocumento='"+idsegflujodocumento+"' and S.respuesta='en proceso' and S.idperfilusuario='"+123+"'").uniqueResult();
		if(count.intValue()==0){
			return true;
		}else{
			return false;
